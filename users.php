...
<div class="relative overflow-x-auto  sm:rounded-lg md:ml-64 w2/3 md:px-32 mt-10">
	...
	<button data-modal-target="default-modal" data-modal-toggle="default-modal" type="button" class="text-white float-right   font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"><lord-icon src="https://cdn.lordicon.com/pdsourfn.json" trigger="hover" style="width:35px;height:35px">
		</lord-icon></button>
			...
			?>
					<tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
						...
						<td class="px-6 py-4 flex ml-auto">
							<button type="button" data-modal-target="updateModal<?= $row['id'] ?>" data-modal-toggle="updateModal<?= $row['id'] ?>" type="button" class="mx-4"><lord-icon src=" https://cdn.lordicon.com/zfzufhzk.json" trigger="hover" style="width:30px;height:30px">
								</lord-icon></button>
							<form method="post">
								<input type="hidden" name="id" value="<?= $row['id'] ?>" />
								<button type="submit" name="delete"> <lord-icon src="https://cdn.lordicon.com/xekbkxul.json" trigger="hover" style="width:30px;height:30px">
									</lord-icon></button>
